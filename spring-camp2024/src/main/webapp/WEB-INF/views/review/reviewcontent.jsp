				...
				<div id="bbsData">
					<div class="page-body">
						<div class="camp-img-div">
							...
							<h1 style="position: relative; right: 350px;">캠핑용품리뷰</h1>
						</div>
						<!-- <div class="bbs-hd">
							<ul class="link">
							...
							<dd>
								<ul>
									<li class="name"><span class="tit">상품명 :</span> <a
										href="assets/img/campReview/review2.jpg">몬테라 테이블 팔아요</a></li>
						...
						<div class="bbs-table-view">
							<table summary="게시글 보기">
								...
								<thead>
									<tr>
										<th><div class="tb-center" style="width: 1100px;">몬테라 테이블 팔아요</div></th>
									</tr>
								</thead>
								<tbody>
									<tr>
							...
							<table id="replyPw">
								<tr>
									<td id="replyBorder"><strong>댓글 비밀번호&nbsp;&nbsp;</strong></td>
								</tr> 
									<input type="password" name="replyPw" id="replyIPw" placeholder=" ※ 입력시 비밀글로 저장">
							</table>
